      ...
      child: Column(
        children: [
                ...
                children: [
                  ClipOval(
                    child: FadeInImage.memoryNetwork(
                        ...
                        image: userInfoModel.userInfo.avatarUrl),
                  ),
                  SizedBox(height: 10),
                  Text(userInfoModel.userInfo.login, style: TextStyle(color: HexColor('#566368'))),
                  SizedBox(height: 10),
                  Text(userInfoModel.userInfo.bio, style: TextStyle(color: HexColor('#566368'))),
                ],
              );
            }),
          ),
          Row(
            ...
            children: Config.personalLinkMap.keys
                .map((imagePath) => buildImageLink(imagePath, Config.personalLinkMap[imagePath]))
                .toList(),
          ),
          SizedBox(height: 30),
            ...
            TextSpan(
              ...
              children: [
                TextSpan(
                  ...
                  text: Config.BLOG,
                  style:
                      TextStyle(color: HexColor('#898989'), decoration: TextDecoration.underline),
                )
              ],
            ),
            textAlign: TextAlign.center,
    ...
    return FractionallySizedBox(
      ...
      child: Consumer<CheckedMenuModel>(
        ...
        builder: (context, checkMenuModel, child) {
          bool checked = (checkMenuModel.isAboutMeChecked && isAboutMe) ||
