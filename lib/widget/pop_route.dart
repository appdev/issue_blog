...
class PopupWindow extends StatefulWidget {
  static void showPopWindow(context, GlobalKey popKey,
      [PopDirection popDirection = PopDirection.bottom, Widget popWidget, double offset = 0]) {
    Navigator.push(
        context,
        PopRoute(
            child: PopupWindow(
  ...
  PopupWindow({this.popWidget, this.popKey, this.popDirection = PopDirection.bottom, this.offset});
